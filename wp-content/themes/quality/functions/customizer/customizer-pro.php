...
class WP_PRO_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    /**
     * Uncomment to show upgrade menu.
     */
...
class WP_document_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
      <div class="pro-box">
	 <a href="<?php echo esc_url('https://help.webriti.com/');?>" target="_blank" class="document" id="review_pro"><?php _e('DOCUMENTATION','quality' ); ?></a>
